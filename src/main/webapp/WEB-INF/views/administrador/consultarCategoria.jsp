		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<div class="col-md-12">
						<h1 style="margin-bottom: 50px;">Consultar Categoria</h1>
						<form class="form-horizontal">
							<div class="input-group">
								<input type="text" path="dsCategoria" class="form-control" placeholder="Pesquisar">
								...
								<tbody>
									<c:forEach var="categoria" items="${listaCategoria}">
										<tr>											
											...
											<td>
												<a href="editarCategoria?cdCategoria=${categoria.cdCategoria}" class="btn overflow-btn btn-pesquisar">Editar</a>
												<c:choose>
													<c:when	test="${categoria.statusCategoria == 'Ativo'}">
														<a href="inativarCategoria?cdCategoria=${categoria.cdCategoria}" class="btn overflow-btn btn-pesquisar">Inativar</a>
													</c:when>
													<c:otherwise>
														<a href="ativarCategoria?cdCategoria=${categoria.cdCategoria}" class="btn overflow-btn btn-pesquisar">Ativar</a>
													</c:otherwise>
												</c:choose>
											</td>
										</tr>
