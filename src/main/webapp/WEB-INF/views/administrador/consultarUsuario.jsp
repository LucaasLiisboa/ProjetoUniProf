...
<html lang="pt-br" ng-app="projetoUniProf">
<head>
	<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<div class="col-md-12">
						<h1 style="margin-bottom: 50px;">Consultar Usuário</h1>
						...
						<div class="table-responsive mar-top5p">
							<table class="table table-striped">
								...
								<tbody ng-repeat="filter: search">
									<c:forEach var="usuario" items="${listaUsuarios}">
										<tr>
											<td>${usuario.nomeUsuario}</td>
											<td>${usuario.sobrenomeUsuario}</td>
											<td>${usuario.emailUsuario}</td>											
											<td>${usuario.dsPermissao}</td>
											<td>
												<a href="editarUsuario?cdUsuario=${usuario.cdUsuario}" class="btn overflow-btn btn-pesquisar">Editar</a>
												<c:choose>
													<c:when	test="${usuario.statusUsuario == 'Ativo'}">
														<a href="inativarUsuario?cdUsuario=${usuario.cdUsuario}" class="btn overflow-btn btn-pesquisar">Inativar</a>
													</c:when>
													<c:otherwise>
														<a href="ativarUsuario?cdUsuario=${usuario.cdUsuario}" class="btn overflow-btn btn-pesquisar">Ativar</a>
													</c:otherwise>
												</c:choose>
											</td>											
										</tr>
