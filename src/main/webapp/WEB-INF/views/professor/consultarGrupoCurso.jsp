		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Consultar Grupo/Curso</h1>
					...
					<div class="table-responsive mar-top5p">
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="curso" items="${listaGrupoCurso}">
									<tr>
										<td>${curso.nomeCurso}</td>
										<td>${curso.grupo.nomeGrupo}</td>										
										<td>
											<a href="novaInscricaoGrupoCursoQuestionario?cdGrupoCurso=${curso.cdGrupoCurso}" class="btn overflow-btn btn-pesquisar">Adicionar Questionário</a>
											<a href="removerInscricaoGrupoCursoQuestionario?cdGrupoCurso=${curso.cdGrupoCurso}" class="btn overflow-btn btn-pesquisar">Remover Questionário</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
