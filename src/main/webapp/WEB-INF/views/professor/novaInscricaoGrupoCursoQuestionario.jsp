		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Inscrever Grupo/Curso no Questionário</h1>
					...
					<div class="col-md-offset-2 col-md-8" style="margin-top: 5%;">
						<form:form modelAttribute="curso">
							...
							<div class="form-group">
								...
								<form:input type="text" id="nomeGrupo" path="grupo.nomeGrupo" name="nomeGrupo" class="form-control" placeholder="Nome do Grupo" disabled="true"/>
							</div>
						</form:form>
					</div>
								...
								<tbody>
									<c:forEach var="questionario" items="${listaQuestionarios}">
										<tr>
											...
											<td>
												<a href="inscreverGrupoQuestionario?cdQuestionario=${questionario.cdQuestionario}" class="btn overflow-btn btn-pesquisar">Inscrever</a>											
											</td>
										</tr>
									</c:forEach>
								</tbody>
