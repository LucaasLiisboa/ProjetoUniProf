		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Remover Questão do Questionário</h1>
								...
								<c:forEach var="questao" items="${listaQuestoes}">
									<tr>
										...
										<td>
											...
											<a href="removeQuestao?cdQuestao=${questao.cdQuestao}" class="btn overflow-btn btn-pesquisar">Remover</a>												
										</td>
									</tr>
								</c:forEach>
							</tbody>
