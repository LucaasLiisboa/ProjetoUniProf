		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Remover Grupo/Curso do Questionário</h1>
								...
								<tbody>
									<c:forEach var="questionario" items="${listaQuestionarios}">
										<tr>
											...
											<td>
												<a href="removeGrupoQuestionario?cdQuestionario=${questionario.cdQuestionario}" class="btn overflow-btn btn-pesquisar">Remover</a>											
											</td>
										</tr>
									</c:forEach>
								</tbody>
