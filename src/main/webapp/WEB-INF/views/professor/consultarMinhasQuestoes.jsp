		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Consultar Questão</h1>
								...
								<c:forEach var="questao" items="${listaQuestoes}">
									<tr>
										...
										<td>
											...
											<a href="detalharQuestoes?cdQuestao=${questao.cdQuestao}" class="btn overflow-btn btn-pesquisar">Detalhar</a>
											<a href="editarQuestao?cdQuestao=${questao.cdQuestao}" class="btn overflow-btn btn-pesquisar">Editar</a>
											<c:choose>
												<c:when	test="${questao.statusQuestao == 'Ativo'}">
													<a href="inativarQuestao?cdQuestao=${questao.cdQuestao}" class="btn overflow-btn btn-pesquisar">Inativar</a>
												</c:when>
												<c:otherwise>
													<a href="ativarQuestao?cdQuestao=${questao.cdQuestao}" class="btn overflow-btn btn-pesquisar">Ativar</a>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
