...
<%@ page import="com.projeto.uniprof.model.Questionario" %>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Responder Questionario</h1>

					<form:form class="form-horizontal" action="incluirRespostaQuestionario" modelAttribute="questionario" method="post">						
						<c:forEach var="questoes" items="${listaQuestoes}" varStatus="count">
							<form:hidden path="questao.cdQuestao"/>
							...
							<div id="marb-10" class="input-group">
								<span class="input-group-addon">
									<form:radiobutton path="questao.resposta.listaRespostas[${count.index}]" value="A"/>
								</span>
							...
							<div id="marb-10" class="input-group">
								<span class="input-group-addon">
									<form:radiobutton path="questao.resposta.listaRespostas[${count.index}]" value="B"/>
								</span>
							...
							<div id="marb-10" class="input-group">
								<span class="input-group-addon">
									<form:radiobutton path="questao.resposta.listaRespostas[${count.index}]" value="C"/>
								</span>
							...
							<div id="marb-10" class="input-group">
								<span class="input-group-addon">
									<form:radiobutton path="questao.resposta.listaRespostas[${count.index}]" value="D"/>
								</span>
							...
							<div id="marb-10" class="input-group">
								<span class="input-group-addon">
									<form:radiobutton path="questao.resposta.listaRespostas[${count.index}]" value="E"/>
								</span>
						...
						<div class="text-right">
							<button type="submit" class="btn btn-form-uniprof col-md-offset-10 col-md-2">Enviar</button>
						</div>
					</form:form>
				</div>
			</div>
