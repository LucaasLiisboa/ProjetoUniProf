		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<div class="col-md-12">
						<h1 style="margin-bottom: 50px;">Remover Usuário do Grupo</h1>
										...
										<c:forEach var="usuario" items="${listaUsuarios}">
											<tr>
												...
												<td>
													...
													<a href="removerUsuarioGrupo?cdUsuario=${usuario.cdUsuario}" class="btn overflow-btn btn-pesquisar">Remover</a>
												</td>											
											</tr>
										</c:forEach>
									</tbody>
