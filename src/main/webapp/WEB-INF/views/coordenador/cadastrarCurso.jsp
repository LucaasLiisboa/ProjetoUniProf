		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Cadastrar Curso</h1>
					<div class="col-md-offset-2 col-md-8">
						<form:form class="form-horizontal" action="cadastrarCurso" method="post" modelAttribute="curso">
							<div class="form-group">
								<label for="curso">Nome Curso</label>
								<form:input type="text" id="nomeCurso" path="nomeCurso" name="nomeCurso" class="form-control" placeholder="Nome do Curso"/>
							</div>
							
							<div class="form-group">
								<label for="dsCurso">Descrição Curso</label>
								<form:input type="text" id="dsCurso" path="dsCurso" name="dsCurso" class="form-control" placeholder="Descrição do Curso"/>
							</div>
