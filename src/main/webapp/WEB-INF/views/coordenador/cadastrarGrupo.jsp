		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Cadastrar Grupo</h1>
					<div class="col-md-offset-2 col-md-8">
						<form:form class="form-horizontal" action="cadastrarGrupo" method="post" modelAttribute="grupo">
							<div class="form-group">
								<label for="grupo">Nome do Grupo</label>
								<form:input type="text" id="nomeGrupo" path="nomeGrupo" name="nomeGrupo" class="form-control" placeholder="Nome do Grupo"/>
							</div>
							
							<div class="form-group">
								<label for="grupo">Descrição do Grupo</label>
								<form:input type="text" id="dsGrupo" path="dsGrupo" name="dsGrupo" class="form-control" placeholder="Descrição do Grupo"/>
							</div>
							
							<div class="form-group">
								<label for="curso">Curso</label>						
								<form:select path="curso.cdCurso" class="form-control form">
									<option value="">Selecione</option>
									<c:forEach var="listaCursos" items="${listaCursos}">
										<form:option value="${listaCursos.cdCurso}">
												${listaCursos.nomeCurso}									
											</form:option>
									</c:forEach>
								</form:select>
							</div>
