		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Consultar Meus Grupos</h1>
							...
							<tbody>
								<c:forEach var="grupo" items="${listaGrupos}">
									<tr>
										...
										<td>${grupo.dsGrupo}</td>
										<td>
											<a href="detalharMeusGrupos?cdGrupo=${grupo.cdGrupo}" class="btn overflow-btn btn-pesquisar">Detalhar</a>
											<a href="editarGrupo?cdGrupo=${grupo.cdGrupo}" class="btn overflow-btn btn-pesquisar">Editar</a>
											<c:choose>
												<c:when	test="${grupo.statusGrupo == 'Ativo'}">
													<a href="inativarGrupo?cdGrupo=${grupo.cdGrupo}" class="btn overflow-btn btn-pesquisar">Inativar</a>
												</c:when>
												<c:otherwise>
													<a href="ativarGrupo?cdGrupo=${grupo.cdGrupo}" class="btn overflow-btn btn-pesquisar">Ativar</a>
												</c:otherwise>
											</c:choose>
											<a href="adicionarGrupoUsuario?cdGrupo=${grupo.cdGrupo}" class="btn overflow-btn btn-pesquisar">Adicionar Usuário</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
