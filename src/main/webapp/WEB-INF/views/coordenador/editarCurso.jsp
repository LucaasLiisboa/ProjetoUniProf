		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Editar Curso</h1>
					
					<div class="col-md-offset-2 col-md-8">
						<form:form class="form-horizontal" action="salvarCurso" method="post" modelAttribute="curso">
							<form:hidden path="cdCurso"/>
							
							<div class="form-group">
								<label for="nome">Nome</label>
								<form:input type="text" id="nomeCurso" path="nomeCurso" name="nomeCurso" class="form-control" placeholder="Nome Curso"/>
							</div>
							
							<div class="form-group">
								<label for="descricao">Descrição</label>
								<form:input type="text" id="dsCurso" path="dsCurso" name="dsCurso" class="form-control" placeholder="Descrição Curso"/>
							</div>
