		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-9 content-corpo">
					<h1 style="margin-bottom: 50px;">Detalhar Meus Cursos</h1>
					...
					<div class="text-right">
						<a href="adicionarGrupoCurso?cdCurso=${curso.cdCurso}" class="btn btn-form-uniprof col-md-offset-7 col-md-3">Adicionar Grupo</a>
						<a href="deletaGrupoCurso?cdCurso=${curso.cdCurso}" class="btn btn-form-uniprof col-md-offset-7 col-md-3">Remover Grupo</a>
					</div>
				</div>
			</div>
		</div>
